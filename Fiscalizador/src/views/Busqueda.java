...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		JLabel lblNewLabel_4 = new JLabel("Busqueda de registros");
		lblNewLabel_4.setForeground(Color.black);
		lblNewLabel_4.setFont(new Font("Verdana", Font.BOLD, 30));
		lblNewLabel_4.setBounds(100, 62, 400, 42);
		...
		tbRegistros.setFont(new Font("Roboto", Font.PLAIN, 16));
		...
		panel.addTab("Regitro", new ImageIcon(Busqueda.class.getResource("/imagenes/reservado.png")), scroll_table, null);
